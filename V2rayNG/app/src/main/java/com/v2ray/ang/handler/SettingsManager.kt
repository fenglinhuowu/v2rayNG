...
object SettingsManager {
    ...
    private fun ensureDefaultSettings() {
        ...
        ensureDefaultValue(AppConfig.PREF_USE_HEV_TUNNEL, true)
        ensureDefaultValue(AppConfig.PREF_VPN_BYPASS_LAN, AppConfig.DEFAULT_VPN_BYPASS_LAN)
    ...
    private fun ensureDefaultValue(key: String, default: Boolean) {
        if (!MmkvManager.settingsContainsKey(key)) {
            MmkvManager.encodeSettings(key, default)
        }
    }
